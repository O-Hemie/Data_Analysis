...
# Import data
df = pd.read_csv('medical-data-visualizer-master/medical_examination.csv')
...
def draw_cat_plot():
    ...
    df_cat = pd.melt(df_cat, id_vars=['cardio'], value_vars=['cholesterol', 'gluc', 'smoke', 'alco', 'active', 'overweight'])
    ...
    fig = sns.catplot(x='variable', y= 'total', col='cardio', hue='value',
                       kind = 'bar', data=df_cat).figure
