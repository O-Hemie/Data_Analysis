...
def calculate_demographic_data(print_data=True):
    ...
    count_bachelors = df.loc[df['education']=='Bachelors']['education'].count()
    number_of_education = df['education'].count()
    percentage_bachelors = (count_bachelors/number_of_education * 100).round(1)
    ...
    lower_education_rich = round(100 * (lower_education / (number_of_education - len(higher_education_2)) ) ,1 )
